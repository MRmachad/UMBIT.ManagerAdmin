var app = {
                ...
                if (e && e.classList.contains(app.sidebar.minify.toggledClass)) {
                    ...
                    if (t) {
                        ...
                        var C = document.querySelector(app.sidebar.floatSubmenu.arrow.id)
                            , L = document.querySelector(app.sidebar.floatSubmenu.line.id);
                        if (m - p > i)
                            g && (g.style.top = p + "px",
                                g.style.left = c + "px",
                                g.style.bottom = "auto",
    ...
    , handleSetPageOption = function (e) {
        ...
        if (a) {
            ...
            if (e.appHeaderInverse)
                (s = document.querySelector("." + app.header.class)) && s.classList.add(app.header.inverse.class);
    ...
    , handleClearPageOption = function (e) {
        ...
        if (a) {
            ...
            if (e.appHeaderInverse)
                (s = document.querySelector("." + app.header.class)) && s.classList.remove(app.header.inverse.class);
            if (e.appWithoutSidebar)
